...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:/IdeaProjects/mdh/gmall-parent/gmall-mbg" + "/src/main/java");
        gc.setAuthor("mdh");
        ...
        dsc.setUrl("jdbc:mysql://47.100.77.124:3306/gmall_"+ moduleName +"?useUnicode=true&useSSL=false&characterEncoding=utf8");
